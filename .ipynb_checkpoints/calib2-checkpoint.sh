...
pipetask run \
   -j 25 \
   -d "instrument='LATISS' AND detector in (0) AND exposure.observation_type = 'flat' AND exposure.observation_reason = 'flat' AND physical_filter='SDSSr_65mm~empty' AND exposure.day_obs=20230803" \
   -b ${REPO} \
   -i u/abrought/latiss/sbias.2023.08.03,u/abrought/latiss/defects.2023.08.03,u/abrought/latiss/dark.2023.08.03,LATISS/raw/all,LATISS/calib \
   -o u/abrought/latiss/sflat.SDSSr_65mm.2023.08.03 \
   -p ${CONFIG}/cpFlat.yaml \
   --register-dataset-types

pipetask run \
   -j 25 \
   -d "instrument='LATISS' AND detector in (0) AND exposure.observation_type = 'flat' AND exposure.observation_reason = 'flat' AND physical_filter='SDSSi_65mm~empty' AND exposure.day_obs=20230803" \
   -b ${REPO} \
   -i u/abrought/latiss/sbias.2023.08.03,u/abrought/latiss/defects.2023.08.03,u/abrought/latiss/dark.2023.08.03,LATISS/raw/all,LATISS/calib \
   -o u/abrought/latiss/sflat.SDSSi_65mm.2023.08.03 \
   -p ${CONFIG}/cpFlat.yaml \
   --register-dataset-types
